...
<div>{% include figure.liquid path="assets/img/data_science/SVM_2.png" class="img-fluid rounded z-depth-1" %}</div>
...
<div>{% include figure.liquid path="assets/img/data_science/SVM_hw_1.png" class="img-fluid rounded z-depth-1" %}</div>