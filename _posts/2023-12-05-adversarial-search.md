...
<div>{% include figure.liquid loading="eager" path="assets/img/ai/tree.png" class="img-fluid rounded z-depth-1" %}</div>
...
<div>{% include figure.liquid loading="eager" path="assets/img/ai/stochastic-game.png" class="img-fluid rounded z-depth-1" %}</div>
